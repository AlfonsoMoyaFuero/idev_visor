...
class IdevDockWidget(QtWidgets.QDockWidget, FORM_CLASS):
    ...
    def createTree(self):
        ...
        if self.rdb_cas.isChecked() == True: # Create the fahther and child nodes in spanish
            ...
            mediorural.setText(0, "Medio ambiente")
        ...
        if self.rdb_val.isChecked() == True:  # Create the fahther and child nodes in valencian
            ...
            infrateleco = QTreeWidgetItem(infraestructuras)
            infrateleco.setText(0, "Telecomunicacions")

            infratransport = QTreeWidgetItem(infraestructuras)
            infratransport.setText(0, "Transports")
